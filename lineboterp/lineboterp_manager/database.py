...
def puring_trastate(manufacturerV_id):
  ...
  categorythree ='notselect' #重試類別select/notselect
  ...
  categoryfour ='notselect' #重試類別select/notselect
