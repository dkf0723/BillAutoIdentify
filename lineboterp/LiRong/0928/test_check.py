...
def product_modification():
    ...
    message = manager.msg
    product = manager.product
    manufacturer_id = product.get(id + 'Product_Modification_manufacturer_id')
    product_status = product.get(id + 'Product_Modification_Product_status')
    ...
    if state[id] == 'Product_Modification_Product':
        ...
        if '商品名稱' == info:
            ...
            state[id] = 'Product_Modification_Punit price sold'
    ...
    elif state[id] == 'Product_Modification_Product_Pname':
        if message != '取消':
