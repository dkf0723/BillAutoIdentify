...
*/
    ...
    const checkr4c1 = document.getElementById("checkr4c1").value;
    const checkr4c2 = document.getElementById("checkr4c2").value;
    const checkr4c3 = document.getElementById("checkr4c3").value;
    const checkr4c4 = document.getElementById("checkr4c4").value;
    const checkr4c5 = document.getElementById("checkr4c5").value;

    if (checkr4c1 === "" || checkr4c2 === "" || checkr4c3 === "" || checkr4c4 === "" || checkr4c5 === "") {
        checkr4c1 += 0;
        checkr4c2 += 0;
        checkr4c3 += 0;
        checkr4c4 += 0;
    ...
    if (parseInt((document.getElementById("checktotalmini"), 10) !== parseInt(checkr4c1, 10) + parseInt(checkr4c2, 10) + parseInt(checkr4c3, 10) + parseInt(checkr4c4, 10) + parseInt(checkr4c5, 10))) {
...
*/
    ...
    if (global.taxbox === "應稅") {
        if (document.getElementById("checktax").value !== "") {
            ...
            if (taxcheck !== Math.round(parseInt(document.getElementById("checktotalmini").value, 10) * 0.05)) {
